...
function barra()
{
  texto='<form id="Form" method="POST" onsubmit="logeo(this)"><input class="texto" type="email" name="usuario" placeholder="Usuario" required /><input class="texto" type="password" name="clave" placeholder="Clave" required /><input id="boton-login" type="submit" value="Ingresar" />'; 
